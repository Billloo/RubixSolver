...
const AlgorithmsOllRoute = AlgorithmsOllRouteImport.update({ id: '/algorithms/oll', path: '/algorithms/oll', getParentRoute: () => rootRouteImport } as any)
const AlgorithmsPllRoute = AlgorithmsPllRouteImport.update({ id: '/algorithms/pll', path: '/algorithms/pll', getParentRoute: () => rootRouteImport } as any)
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/notation' | '/timer' | '/$lang/$' | '/solver/$puzzle' | '/$lang/' | '/algorithms' | '/algorithms/f2l' | '/algorithms/oll' | '/algorithms/pll' | '/guides/what-is-cfop' | '/learn/how-to-solve-a-rubiks-cube' | '/scramble-generator'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/notation' | '/timer' | '/$lang/$' | '/solver/$puzzle' | '/$lang' | '/algorithms' | '/algorithms/f2l' | '/algorithms/oll' | '/algorithms/pll' | '/guides/what-is-cfop' | '/learn/how-to-solve-a-rubiks-cube' | '/scramble-generator'
  id: '__root__' | '/' | '/notation' | '/timer' | '/$lang/$' | '/solver/$puzzle' | '/$lang/' | '/algorithms' | '/algorithms/f2l' | '/algorithms/oll' | '/algorithms/pll' | '/guides/what-is-cfop' | '/learn/how-to-solve-a-rubiks-cube' | '/scramble-generator'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/algorithms/oll': { id: '/algorithms/oll'; path: '/algorithms/oll'; fullPath: '/algorithms/oll'; preLoaderRoute: typeof AlgorithmsOllRouteImport; parentRoute: typeof rootRouteImport }
    '/algorithms/pll': { id: '/algorithms/pll'; path: '/algorithms/pll'; fullPath: '/algorithms/pll'; preLoaderRoute: typeof AlgorithmsPllRouteImport; parentRoute: typeof rootRouteImport }
...
const rootRouteChildren: RootRouteChildren = {
  ...
  AlgorithmsRoute, AlgorithmsF2lRoute, AlgorithmsOllRoute, AlgorithmsPllRoute, CfopRoute, BeginnerGuideRoute, ScrambleGeneratorRoute,
}
