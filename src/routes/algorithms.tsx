...
function AlgorithmsPage() {
  return <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
    ...
    <section className="mt-8 grid gap-4 md:grid-cols-3">
      <Link to="/algorithms/f2l" className="panel p-6 transition hover:-translate-y-1 hover:border-primary"><h2 className="text-xl font-semibold">F2L</h2><p className="mt-2 text-sm text-muted-foreground">First Two Layers: pair corners and edges efficiently.</p></Link>
      <Link to="/algorithms/oll" className="panel p-6 transition hover:-translate-y-1 hover:border-primary"><h2 className="text-xl font-semibold">OLL</h2><p className="mt-2 text-sm text-muted-foreground">Orient the Last Layer and build toward full OLL.</p></Link>
      <Link to="/algorithms/pll" className="panel p-6 transition hover:-translate-y-1 hover:border-primary"><h2 className="text-xl font-semibold">PLL</h2><p className="mt-2 text-sm text-muted-foreground">Permute the Last Layer and finish a CFOP solve.</p></Link>
    </section>
