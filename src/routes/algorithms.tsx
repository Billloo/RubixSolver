...
function AlgorithmsPage() {
  ...
  return <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
    ...
    <section className="mt-8 grid gap-4 md:grid-cols-3">
      <a href="/algorithms/f2l" className="panel block p-6 transition hover:-translate-y-1 hover:border-primary" aria-label="Learn F2L algorithms"><h2 className="text-xl font-semibold">F2L</h2><p className="mt-2 text-sm text-muted-foreground">First Two Layers: pair corners and edges efficiently.</p><span className="mt-4 inline-block text-sm font-medium text-primary">Learn F2L algorithms →</span></a>
      <a href="/algorithms/oll" className="panel block p-6 transition hover:-translate-y-1 hover:border-primary" aria-label="Learn OLL algorithms"><h2 className="text-xl font-semibold">OLL</h2><p className="mt-2 text-sm text-muted-foreground">Orient the Last Layer and build toward full OLL.</p><span className="mt-4 inline-block text-sm font-medium text-primary">Learn OLL algorithms →</span></a>
      <a href="/algorithms/pll" className="panel block p-6 transition hover:-translate-y-1 hover:border-primary" aria-label="Learn PLL algorithms"><h2 className="text-xl font-semibold">PLL</h2><p className="mt-2 text-sm text-muted-foreground">Permute the Last Layer and finish a CFOP solve.</p><span className="mt-4 inline-block text-sm font-medium text-primary">Learn PLL algorithms →</span></a>
    </section>
