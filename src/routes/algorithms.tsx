...
function AlgorithmsPage() {
  return <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
    ...
    <section className="mt-8 grid gap-4 md:grid-cols-3">
      <a href="/algorithms/f2l" className="panel p-6 transition hover:-translate-y-1 hover:border-primary"><h2 className="text-xl font-semibold">F2L</h2><p className="mt-2 text-sm text-muted-foreground">First Two Layers: pair corners and edges efficiently.</p></a>
      <a href="/algorithms/oll" className="panel p-6 transition hover:-translate-y-1 hover:border-primary"><h2 className="text-xl font-semibold">OLL</h2><p className="mt-2 text-sm text-muted-foreground">Orient the Last Layer and build toward full OLL.</p></a>
      <a href="/algorithms/pll" className="panel p-6 transition hover:-translate-y-1 hover:border-primary"><h2 className="text-xl font-semibold">PLL</h2><p className="mt-2 text-sm text-muted-foreground">Permute the Last Layer and finish a CFOP solve.</p></a>
    </section>
    <section className="mt-8 panel p-6 sm:p-8"><h2 className="text-2xl font-semibold">Learn the notation first</h2><p className="mt-2 text-muted-foreground">Algorithms are much easier to read once you know R, L, U, D, F, B, prime moves, and double turns.</p><div className="mt-4 flex flex-wrap gap-4"><a href="/notation" className="text-sm font-medium text-primary underline">Read the notation guide →</a><a href="/guides/what-is-cfop" className="text-sm font-medium text-primary underline">What is CFOP? →</a></div></section>
  </div>;
}
