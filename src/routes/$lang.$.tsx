...
function InternalLink({ lang, href, label }: { lang: Locale; href: string; label: string }) { return <a href={`/${lang}/${href}`} className="rounded-lg border border-border px-4 py-2 text-sm font-medium hover:bg-accent">{label} →</a>; }
